    ...
    onSubmit: async (values) => {
      ...
      try {
        ...
        const apiUrl = changePasswordMode
          ? `${process.env.NEXT_PUBLIC_BASE_URL}/users/reset-pass`
              ...
              {editDetails && (
                <>
                  {editName ? (
                    ...
                    <>
                      <div className="flex items-center justify-center md:justify-start">
                        <h1 className="mb-6 bdcn mt-8 text-4xl font-bold md:mx-10 md:text-5xl lg:mx-12 lg:text-5xl xl:mx-16 2xl:mx-20 2xl:text-7xl">
                  ...
                  <div className={`flex items-center justify-center mt-4`}>
                    ...
                    >
                      <span>
                        {!changeInnerText ? "Save Changes" : "Saving..."}
                      </span>
                    </button>
                  </div>
                </>
