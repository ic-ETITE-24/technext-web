  ...
  return (
    <>
      <div className={CSS.background}>
        <div className="mx-10 text-white md:mx-20 text-lg sm:text-4xl font-[600] py-2 mb-12">
          OUR INVESTMENT PARTNERS
        </div>
        <div className="flex flex-col justify-center lg:flex-row gap-y-4 lg:mt-20">
          <div className="mx-auto my-auto h-[40%] w-[80%] lg:w-[30%] sm:w-[60%] rounded-md pb-3 backdrop-blur-md backdrop-brightness-125">
          ...
          <div className="mx-auto my-auto h-[40%] w-[80%] lg:w-[30%] sm:w-[60%] rounded-md pb-5 backdrop-blur-md backdrop-brightness-125">
            <div className="flex flex-col justify-center">
              <Image
                src={inv2}
                alt="investor1"
