        ...
        <div className="flex flex-col gap-5">
          ...
          <div className="mx-auto my-auto h-[100%] w-[90%] lg:w-[90%] sm:w-[80%] rounded-md backdrop-blur-md backdrop-brightness-125 lg:mt-5">
            <div className="flex px-10 justify-between items-center">
              ...
              <div className="flex flex-col justify-center mr-[6rem] gap-10 ">
                <h1 className="self-center text-center text-white/80  text-lg sm:text-6xl ">
                  SHIJU BABU
                </h1>
                <div className=" text-white text-sm sm:text-6xl font-[800px] py-2 pb-6  text-justify ">
                  <span className="text-[#FF7A00] sm:text-[3.85rem]">
                    START UP
                  </span>{" "}
                  INDIA MENTOR
                </div>
