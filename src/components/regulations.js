    ...
    <>
      <div className={css.bg}>
        ...
        <div className="flex flex-col items-center md:flex-row sm:pt-56 pt-10 justify-center md:pt-20 lg:pt-0 2xl:pt-20 lg:w-full">
          <div className="flex justify-center text-white pt-9 md:pl-8 md:pr-8 lg:pl-4 lg:pr-48 2xl:pl-0 xl:pr-96 md:text-lg text-xs opacity-30 py-4 sm:py-0 md:w-full">
            * 3 MEMBERS CAN ALSO FORM A TEAM
          </div>
          <div className="w-full flex justify-center md:justify-end md:px-10">
