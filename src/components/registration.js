      ...
      <div className={css.bg}>
        ...
        <div className="flex flex-col items-center px-5">
          <div className="flex flex-col rounded-lg p-5 border-4 border-double border-orange-500 ">
            ...
            <p className=" text-orange-500 text-4xl text-center sm:text-3xl md:text-5xl font-bold"> TILL 26th JANUARY, 2024</p>
          </div>
        ...
        <div className="flex flex-col items-center md:flex-row sm:pt-56 pt-10 justify-center md:pt-20 lg:pt-0 2xl:pt-20 lg:w-full">
          <div className="flex bdcn justify-center text-white pt-9 md:pl-12 lg:pl-4 xl:pl-8 2xl:pl-0 xl:pr-40 md:text-lg text-xs opacity-30 py-4 sm:py-0 md:w-full">
