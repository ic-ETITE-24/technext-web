      ...
      <div className={CSS.background}>
        <div className="flex justify-between items-center w-full pt-6">
          ...
          <div className="text-center flex flex-wrap justify-end items-center mr-4">
            ...
            <a
              href="/input_page"
              className="uppercase mx-[15px] my-1 sm:mx-[30px] px-2 sm:px-5 py-1 sm:py-2 sm:text-xl text-[10px] bg-[#FF7A00] sm:rounded-lg rounded-md hover:bg-[#ff9837] hover:text-white hover:font-[400] active:bg-[#FF7A00]"
            >
              Download Brochure
            </a>
          </div>
